...
import { Beer, Calculator, ShoppingCart, Building2, TrendingUp, BarChart3, Users, Settings, MessageCircle, Search } from 'lucide-react'
      ...
      homebrewer: [
        {
          ...
          description: '① Plan: Create and analyze recipes with live ABV/IBU/SRM calculations',
          icon: Calculator,
          href: '/recipe',
        ...
        {
          title: 'Shopping List',
          description: '② Shop: Generate ingredient shopping lists with vendor links',
          icon: ShoppingCart,
          href: '/shopping',
        ...
        {
          title: 'Brewing Guide',
          description: '③ Brew: Step-by-step brewing instructions with interactive timers',
          icon: Beer,
          href: '/brew',
